...
setTimeout(function () {
    $('.main-wrapper').append('<div class="sidebar-settings nav-toggle" id="layoutDiv">' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-01.jpg" alt="">' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-02.jpg" alt="">' +
        ...
        '<a href="../template/index.html"><img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-01.jpg" alt=""></a>' +
        ...
        '<a href="../template-rtl/index.html" target="_blank"><img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-03.jpg" alt=""></a>' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-07.jpg" alt="">' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-05.jpg" alt="">' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-06.jpg" alt="">' +
        ...
        '<img src="'+AppConfig.baseUrl+'/theme/img/theme/theme-img-04.jpg" alt="">' +
...
loadJS(''+AppConfig.baseUrl+'/theme/js/theme-settings.js', true);
